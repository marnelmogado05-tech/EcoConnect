...
<head>
    ...
    <title>Forgot Password - EcoConnect</title>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <div class="mb-4 text-center mb-md-5">
                        <h1 class="leaf-decoration h2 h1-md">Reset Your Password</h1>
                        <p class="small">Enter your email address to receive a password reset link</p>
                    </div>

                    <!-- Forgot Password Card -->
                    <div class="p-3 card p-md-4 p-lg-5">
                        <!-- Instructions -->
                        <div class="mb-4 small text-muted" style="line-height: 1.5;">
