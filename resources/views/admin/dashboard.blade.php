...
@section('content')
    ...
    <div class="shadow-sm card">
        <div class="gap-2 card-header bg-light d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center">
            ...
            <a href="{{ route('admin.incidents') }}" class="btn btn-outline-primary btn-sm">
        ...
        <div class="p-0 card-body">
            ...
            @else
                <div class="py-5 text-center">
                    ...
                    <h6 class="mb-2 text-muted">No incidents matching your criteria</h6>
                    <p class="mb-0 text-muted small">Recent activity will appear here</p>
                </div>
            @endif
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="{{ route('admin.incidents') }}" class="py-4 btn btn-outline-primary w-100 h-100 d-flex flex-column align-items-center text-decoration-none">
                        <i class="mb-2 fas fa-search fa-2x"></i>
                        <span class="fw-semibold">View Incident Reports</span>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="{{ route('admin.citizens') }}" class="py-4 btn btn-outline-secondary w-100 h-100 d-flex flex-column align-items-center text-decoration-none">
                        <i class="mb-2 fas fa-users fa-2x"></i>
                        <span class="fw-semibold">Manage Citizens</span>
                    </a>
                </div>
                <div class="col-12 col-sm-6 col-md-3">
                    <a href="{{ route('admin.police') }}" class="py-4 btn btn-outline-secondary w-100 h-100 d-flex flex-column align-items-center text-decoration-none">
                        <i class="mb-2 fas fa-shield-alt fa-2x"></i>
                        <span class="fw-semibold">Manage Police</span>
                    </a>
                </div>
            </div>
        </div>
