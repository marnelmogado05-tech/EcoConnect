@extends('layouts.app')
@section('title', 'Manage Police Officers | EcoConnect - DENR CENRO Sanchez Mira')
@section('page-title', 'Police Officers Management')
@section('content')
    <section id="policeOfficers" class="py-4">
        <div class="container-fluid">
            ...
            <div class="mb-4 row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="mb-1">Police Officers Management</h2>
                            <p class="mb-0 text-muted">Manage all registered Police Officers and their reports</p>
                        </div>
                        <!-- Add Police Officer Button -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addPoliceOfficerModal">
                            <i class="fas fa-plus me-2"></i> Add Police Officer
                        </button>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <p class="mb-0">Total Police Officers</p>
                                </div>
            ...
            <div class="mb-4 card">
                <div class="card-body">
                    <form method="GET" action="{{ route('admin.police') }}" id="filterForm">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('admin.police') }}" class="btn btn-secondary">
                ...
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="gap-2 d-flex">
                        <span class="text-muted">
                            Showing {{ $police->firstItem() }} to {{ $police->lastItem() }} of {{ $police->total() }} policeOfficers
                        </span>
                    </div>
                </div>
                    ...
                    @if($police->count() > 0)
                        <div class="table-responsive">
                            ...
                            <table class="table mb-0 table-hover table-striped">
                                <thead class="table-light">
                                    <tr>
                                        <th width="200">Police Officer</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="align-middle">
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('admin.police.show', $officer->id) }}"
                                                class="btn btn-outline-primary"
                                                title="View Details">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <!-- Edit Police Officer Button (in your table actions) -->
                                                <button type="button" class="btn btn-outline-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editPoliceOfficerModal{{ $officer->id }}" title="Edit">
                                    ...
                                    <div class="modal fade" id="statusModal{{ $officer->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('admin.police.update-status', $officer->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <div class="modal fade" id="editPoliceOfficerModal{{ $officer->id }}" tabindex="-1" aria-labelledby="editPoliceOfficerModalLabel{{ $officer->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="editPoliceOfficerModalLabel{{ $officer->id }}">
                                                        <i class="fas fa-edit me-2"></i>Edit Police Officer
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                </div>
                                                <form method="POST" action="{{ route('admin.police.update-profile', $officer->id) }}" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                                        <!-- Name Fields -->
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" class="btn btn-primary">
                                                            <i class="fas fa-save me-2"></i>Update Police Officer
                                                        </button>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="card-footer d-flex justify-content-between align-items-center">
                            <div class="text-muted">
                                Showing {{ $police->firstItem() }} to {{ $police->lastItem() }} of {{ $police->total() }} entries
                            </div>
                            <div>
                                {{ $police->onEachSide(1)->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    @else
                        <div class="py-5 text-center">
                            <i class="mb-3 fas fa-users fa-3x text-muted"></i>
                            <h4 class="text-muted">No Police Officers Found</h4>
                            <p class="text-muted">
                                @if(request()->hasAny(['status', 'search']))
                                    No Police Officers match your search criteria.
                                @else
                                    No Police Officers are registered yet.
                                @endif
                            </p>
                        </div>
                    @endif
    ...
    <div class="modal fade" id="addPoliceOfficerModal" tabindex="-1" aria-labelledby="addPoliceOfficerModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addPoliceOfficerModalLabel">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('[id^="editPoliceOfficerModal"]').forEach(function(modal) {
                modal.addEventListener('shown.bs.modal', function() {
                    const officerId = this.id.replace('editPoliceOfficerModal', '');
