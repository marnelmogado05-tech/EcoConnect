...
@section('content')
    <section id="reports" class="py-4">
        <div class="container-fluid">
                        ...
                        <div class="gap-2 d-flex">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="exportDropdown">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('bfp.incidents.export', array_merge(request()->query(), ['format' => 'xlsx'])) }}">
                                            <i class="fas fa-file-excel text-success me-2"></i>Excel (.xlsx)
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="{{ route('bfp.incidents.export', array_merge(request()->query(), ['format' => 'csv'])) }}">
                                            <i class="fas fa-file-csv text-primary me-2"></i>CSV (.csv)
                                        </a>
                                    </li>
                                    {{-- <li>
                                        <a class="dropdown-item" href="{{ route('bfp.incidents.export', array_merge(request()->query(), ['format' => 'pdf'])) }}">
                                            <i class="fas fa-file-pdf text-danger me-2"></i>PDF (.pdf)
                                        </a>
                                    </li> --}}
                                </ul>
                            </div>
                            <a href="{{ route('bfp.incidents.print', request()->query()) }}" class="btn btn-outline-secondary" target="_blank">
            ...
            <div class="mb-4 card">
                <div class="card-body">
                    <form method="GET" action="{{ route('bfp.incidents') }}" id="filterForm">
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <a href="{{ route('bfp.incidents') }}" class="btn btn-secondary">
                                    ...
                                    <div class="modal fade" id="takenModal{{ $incident->id }}" tabindex="-1">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('bfp.incidents.taken', $incident->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
                                    ...
                                    <div class="modal fade" id="resolveModal{{ $incident->id }}" tabindex="-1">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('bfp.incidents.resolve', $incident->id) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="modal-body">
